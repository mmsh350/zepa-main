                    ...
                    <form class="theme-form needs-validation" id="register_form" novalidate>
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12">
                                ...
                                <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="e.g email@gmil.com" tabindex="1" required />
                            </div>
                            <div class="col-xl-12">
                                <label for="signup-password" class="form-label text-default">Password</label>
                                <div class="input-group">
                                    <input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="Password" tabindex="3" required />
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control form-control-lg" id="password_confirmation" name="password_confirmation" placeholder="Confirm password" tabindex="4" required />
                            ...
                            <div class="col-xl-12 mb-2">
                                ...
                                <a href="javascript:void(0);" data-bs-toggle="tooltip" title="Were you referred by someone? Enter their referral code below" data-bs-custom-class="tooltip-secondary" class="me-3"><i class="ri-information-line"></i></a>
                                <input type="text" class="form-control form-control-lg" id="referral_code" name="referral_code" maxlength="6" placeholder="Idris19209" tabindex="2" />
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="checkbox" value="" id="terms" name="terms" tabindex="5">
                                    <label class="form-check-label text-muted fw-normal" for="defaultCheck1">
                                        By creating an account you agree to our <a href="{{ route('terms') }}" class="text-success"><u>Terms & Conditions</u></a>
                                    </label>
                                </div>
                            </div>
