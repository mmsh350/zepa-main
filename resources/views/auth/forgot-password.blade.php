                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                    <div class="card custom-card">
                        ...
                        <img src="{{ asset('assets/images/brand-logos/logo-dark.jpg')}}" alt="logo" class="desktop-dark" style="width:60px; height:55px">
                            ...
                            <p class="mb-4 text-muted op-7 fw-normal text-center"> Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one. </p>
                              ...
                              @csrf
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-12 d-grid mt-3">
                                        <button type="submit" id="reset" class="btn btn-lg btn-primary">Email Password Reset Link</button>
                                    </div>
                                </div>
                           </form>
                        </div>
