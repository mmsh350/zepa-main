                            ...
                            <input type="hidden" name="token" value="{{ $request->route('token') }}">
                              <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <input type="email"  class="form-control form-control-lg"  id="email"  name="email" readonly value="{{ $request->email}}"  required/>
                                </div>
                               <div class="col-xl-12">
                                <label for="new-password" class="form-label text-default">New Password</label>
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="Password" tabindex="1" autofocus required/>
                                ...
                                <div class="col-xl-12 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg" id="password_confirmation" name="password_confirmation" placeholder="Confirm password" tabindex="2" required/>
                                ...
                                <div class="col-xl-12 d-grid mt-2">
                                   <button type="submit" id="reset" class="btn btn-lg btn-primary" tabindex="3"> Reset Password </button>
                                </div>
                            </div>
                        </form>
