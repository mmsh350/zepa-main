        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ env('APP_URL') }}">
                    <img src="{{ asset('assets/home/images/logo/logo.png') }}" alt="Logo" width="40"
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/') }}#api"
                                onclick="return confirm('Coming Soon!')">API Services</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container-sm">
                <div class="row">
                    <div class="col-12 col-md-6 text-center text-md-start">
                        <p class="creadits">&copy; 2024 Created by: <a href="{{ url('/') }}">Zepa solutions</a>
                        </p>
                    </div>
