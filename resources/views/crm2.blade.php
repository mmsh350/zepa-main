            ...
            <div class="container-fluid">
               ...
               <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                  <div>
                     ...
                     <span class="fs-semibold text-muted">Submit a CRM request Using Surname, phone number, and date of birth (DOB) to receive assistance with BVN-related issues.</span>
                  </div>
               </div>
               <!-- End::page-header -->
               <!-- Start::row-1 -->
                                            ...
                                            <form name="crm2-request" method="POST" action="{{route('crmRequest2')}}">
                                                ...
                                                <div class="mb-2 row">                                                    
                                                     <div class="col-md-12 mt-2">
                                                        ...
                                                        <input type="text" id="surname" name="surname" class="form-control text-center" required/>
                                                      </div>
                                                     <div class="col-md-12 mt-2">
