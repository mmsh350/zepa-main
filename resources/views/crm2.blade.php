            ...
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <div>
                        ...
                        <span class="fs-semibold text-muted">Submit a CRM request Using Surname, phone number, and date
                            of birth (DOB) to receive assistance with BVN-related issues.</span>
                    </div>
                </div>
                <!-- End::page-header -->
                <!-- Start::row-1 -->
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                @endif
                                                <form id="form" name="crm2-request" method="POST"
                                                    action="{{ route('crmRequest2') }}">
                                                    @csrf
                                                    <div class="mb-2 row">
                                                        <div class="col-md-12 mt-2">
                                                            <p class="mb-2 form-label"> Surname </p>
                                                        ...
                                                        <div class="col-md-12 mt-2">
                                                            ...
                                                            <input type="text" id="phone_number" name="phone_number"
                                                                maxlength="11" class="form-control phone text-center"
                                                                required />
                                                        </div>
                                                        <div class="col-md-12">
                                                            <p class="mb-2 form-label mt-2"> Date of Birth:(mm/dd/yyyy)
                                                            </p>
                                                    ...
                                                    <button type="submit" id="crm2-request" class="btn btn-primary"><i
