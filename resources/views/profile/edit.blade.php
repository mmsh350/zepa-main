        ...
        <div class="card custom-card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('profile.update')}}">
                    ...
                    <button type="submit" id="change_password" class="btn btn-primary">Update Password</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="col-xxl-12  col-md-6">
        <div class="card custom-card mb-4">
            ...
            <div class="card-body" style="margin-bottom:105px;">
                 <small class="text-dark">To create or update your PIN, enter your password and the One-Time Password (OTP) sent to your registered email."</small>
            ...
            <form id="update-pin-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="password_for_pin" name="password" required>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="otp-form">
                    @csrf
                    <div class="mb-3">
                         <p>OTP sent to your registered email address. Please check your inbox. <br/></p>
                        <label for="otp" class="form-label">OTP</label>
                        <input type="text" class="form-control" maxlength="6" id="otp" name="otp" required>
                    </div>
                    <div class="mb-3">
                        <label for="new_pin" class="form-label">New PIN</label>
                        <input type="text" class="form-control" maxlength="4" id="new_pin" name="pin" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button"  class="btn btn-primary" id="verify-otp">Verify OTP
                     <div class="lds-ring" id="spinner2"><div></div><div></div><div></div><div></div></div>
                </button>
            </div>
        </div>
    </div>
       ...
       @if(Auth::user()->role != 'agent')
                ...
                <h5 class="card-title"> Account Upgrade</h5>
                                    ...
                                    <div class="card-body">
                                       ...
                                       @csrf
                                      <fieldset>
                                             <p class="text-center">Upgrade your account now and unlock access to our exclusive agency services. Take your experience to the next level!</p>
                                        <div class="mb-3 col-md-12" >
                                            <select  id="type" name="type" class="form-select mt-3 text-center">
                                                <option value=""> --- Select Package---</option>
                                                <option value="agent">Agent Package </option>
                                            </select>
                                       </div>
                                        <center>
                                        <button type="button" id="upgrade" class="btn btn-primary mb-3"><i class="las la-sync-alt"></i> Activate Now</button>
                                       </center>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('notification.update')}}">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="notification_sound" name="notification_sound" {{ $is_enabled ? 'checked' : '' }}>
                        <label class="form-check-label" for="notification_sound">
                            Enable Notification Sound
                        </label>
                    </div>
                    <button type="submit" id="notify" class="btn btn-primary mt-3">Save Settings</button>
                </form>
            </div>
        </div>
    </div>
