<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('current_password')" class="mt-2 alert alert-danger alert-dismissible fade show" />
        </div>
        ...
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('password')" class="mt-2 alert alert-danger alert-dismissible fade show" />
        </div>
        ...
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('password_confirmation')" class="mt-2 alert alert-danger alert-dismissible fade show" />
        </div>
